...
# Buttons
menu_button1 = ctk.CTkButton(root, text='Select image', text_color="#FFFFFF", command=select_image,
                             fg_color="#08b6d9", hover_color="#087bb8", width=200, height=35, font=("Arial", 16, "bold"))
